...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        public void EmitClasses(Node root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/Flo4604/go-steam/v5/steamid\"");
            sb.AppendLine("    \"github.com/Flo4604/go-steam/v5/rwu\"");
            sb.AppendLine("    \"github.com/Flo4604/go-steam/v5/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
